...
func (_e *MockProduct_Expecter) InsideTx(ctx interface{}, cb interface{}) *MockProduct_InsideTx_Call {
	return &MockProduct_InsideTx_Call{Call: _e.mock.On("InsideTx", ctx, cb)}
}

func (_c *MockProduct_InsideTx_Call) Run(run func(ctx context.Context, cb func(context.Context) error)) *MockProduct_InsideTx_Call {
	_c.Call.Run(func(args mock.Arguments) {
